...
N
. Find the minimum positive integer divisible by both 
2
 and 
N
.
...
Output
Print the minimum positive integer divisible by both 
2
 and 
N
.
...
2
 and 
3
. Also, there is no positive integer less than 
6 that is divisible by both  2  and  3
